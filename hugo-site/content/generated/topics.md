...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-list"></i>&nbsp;专题系列</h2></div>
    <div class="topic-grid">
      <section class="topic-card">
        <h3><a href="/topics/java-jvm.html">Java 与 JVM</a></h3>
        <p>Java 基础、集合、反射、并发、JVM、GC 与排障相关内容。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2019/09/17/1568731586414.html">JVM 基础总览</a></li>
<li><a href="/articles/2019/09/17/1568733889287.html">JVM 垃圾回收器</a></li>
<li><a href="/articles/2025/07/16/1752652246705.html">LocalDateTime操作</a></li>
<li><a href="/articles/2021/03/29/1617000615780.html">java内省机制与反射机制的区别</a></li>
        </ol>
        <span>26 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/spring-backend.html">Spring Boot 与后端框架</a></h3>
        <p>Spring Boot、Spring Batch、MyBatis、Swagger、WebFlux、自动装配和扩展点实践。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2021/05/14/1620960509044.html">Spring Boot 启动扩展点</a></li>
<li><a href="/articles/2021/03/16/1615897840354.html">Spring Integration 中文手册</a></li>
<li><a href="/articles/2021/04/21/1618973105136.html">使用@ConditionalOnExpression决定是否生效</a></li>
<li><a href="/articles/2021/04/21/1618967915021.html">springBatch监控相关</a></li>
        </ol>
        <span>10 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/ai-agent.html">AI、Agent 与本地模型</a></h3>
        <p>AI 工具、本地大模型、Agent、MCP、自托管 AI 工作台和 AI 编程实践。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2026/06/03/odysseus-zhihu.html">Odysseus 本地 AI 工作台体验</a></li>
<li><a href="/articles/2026/06/04/codex-oss-zhihu.html">一个开源维护者视角：为什么我建议大家关注 OpenAI Codex for OSS</a></li>
        </ol>
        <span>2 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/mysql-data.html">MySQL 与数据架构</a></h3>
        <p>MySQL 索引、事务、锁、分库分表、冷热分离、数据一致性与大表优化。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2021/06/08/1623116860957.html">MySQL RR 隔离级别锁测试</a></li>
<li><a href="/articles/2019/09/18/1568819118263.html">分库分表方案总览</a></li>
<li><a href="/articles/2021/03/25/1616640074000.html">表数据量大读写缓慢如何优化【分库分表】</a></li>
<li><a href="/articles/2021/03/25/1616638627630.html">表数据量大读写缓慢如何优化【查询分离】</a></li>
        </ol>
        <span>15 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/linux-ops.html">Linux 运维与部署</a></h3>
        <p>Linux、CentOS、Ubuntu、Nginx、Redis、JDK、Maven、Git、服务器排障和部署记录。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2020/04/20/1587389853090.html">Linux Dump 文件分析</a></li>
<li><a href="/articles/2020/09/10/1599717501006.html">Ubuntu 搭建Zookeeper服务</a></li>
<li><a href="/articles/2020/08/28/1598616084150.html">HAProxy常见的安装方式</a></li>
<li><a href="/articles/2020/05/13/1589349920439.html">Linux - 查看用户登录记录</a></li>
        </ol>
        <span>18 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/python-crawler.html">Python 爬虫与自动化</a></h3>
        <p>Python 环境、requests、urllib、Scrapy、Selenium、ChromeDriver 和爬虫实战。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2019/09/16/1568641811471.html">Scrapy 框架入门</a></li>
<li><a href="/articles/2020/06/16/1592317763420.html">Python3下request处理cookie的两种方法</a></li>
<li><a href="/articles/2020/01/15/1579057224237.html">Python3绘图Turtle库详解</a></li>
<li><a href="/articles/2019/12/14/1576338890909.html">python3下chromedriver + headless + proxy+场景</a></li>
        </ol>
        <span>23 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/middleware-distributed.html">中间件与分布式</a></h3>
        <p>Redis、Zookeeper、网关、HAProxy、SOFA、Prometheus、Grafana、分布式锁和服务治理。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2020/05/28/1590656168798.html">Redis 缓存穿透、击穿、雪崩</a></li>
<li><a href="/articles/2020/12/25/1608882277320.html">各种法则定律-引论</a></li>
<li><a href="/articles/2020/06/14/1592112174081.html">api网关介绍</a></li>
<li><a href="/articles/2020/04/11/1586608404790.html">分布式锁(Redis,zk,db锁)</a></li>
        </ol>
        <span>7 篇文章</span>
      </section>
<section class="topic-card">
        <h3><a href="/topics/tools-blog.html">工具、效率与博客建设</a></h3>
        <p>开发工具、网络分析、Rust 学习、博客迁移、静态站建设和零散效率笔记。</p>
        <ol class="topic-roadmap">
          <li><a href="/articles/2026/05/28/zhihu-bolo-to-vuepress-migration.html">老博客静态化迁移实战</a></li>
<li><a href="/articles/2020/10/29/1603968711195.html">Drools语法</a></li>
<li><a href="/articles/2020/01/04/1578123919824.html">wireshark安装和基本语法</a></li>
<li><a href="/articles/2019/09/24/1569312462439.html">Rust学习之二猜字谜</a></li>
        </ol>
        <span>5 篇文章</span>
      </section>
  </div>
