---
title: nginx
description: nginx 标签已归并到 Nginx，这里保留旧标签入口。
url: /tags/nginx.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;nginx / Nginx (3)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/Nginx.html">Nginx</a>。</p>
