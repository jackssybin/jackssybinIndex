---
title: scrapy
description: scrapy 标签已归并到 Scrapy，这里保留旧标签入口。
url: /tags/scrapy.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;scrapy / Scrapy (6)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/Scrapy.html">Scrapy</a>。</p>
