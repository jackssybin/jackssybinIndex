---
title: mysql
description: mysql 标签已归并到 MySQL，这里保留旧标签入口。
url: /tags/mysql.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;mysql / MySQL (10)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/MySQL.html">MySQL</a>。</p>
