---
title: python实战
description: python实战 标签已归并到 Python 爬虫，这里保留旧标签入口。
url: /tags/python_E5_AE_9E_E6_88_98.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;python实战 / Python 爬虫 (9)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/Python_20_E7_88_AC_E8_99_AB.html">Python 爬虫</a>。</p>
