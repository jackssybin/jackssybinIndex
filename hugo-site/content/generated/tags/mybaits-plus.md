---
title: mybaits-plus
description: mybaits-plus 标签已归并到 MyBatis Plus，这里保留旧标签入口。
url: /tags/mybaits-plus.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;mybaits-plus / MyBatis Plus (2)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/MyBatis_20Plus.html">MyBatis Plus</a>。</p>
