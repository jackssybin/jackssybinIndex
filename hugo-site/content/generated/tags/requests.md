---
title: requests
description: requests 标签已归并到 Requests，这里保留旧标签入口。
url: /tags/requests.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-tags"></i>&nbsp;requests / Requests (1)</h2></div>
    <p class="ft-gray" style="padding:0 20px 12px;">该标签已归并到 <a href="/tags/Requests.html">Requests</a>。</p>
