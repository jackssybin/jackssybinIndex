...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-list"></i>&nbsp;第18章：SQL优化实战 ⭐⭐⭐⭐⭐</h2></div>
...
<section>
      <h4>05</h4>
      <a class="current" href="/mysql/05/18-sql.html">第18章：SQL优化实战 ⭐⭐⭐⭐⭐</a>
...
<a class="" href="/mysql/09/33.html">第33章：疑难问题解决方案</a>
      ...
      <main class="mysql-course-main">
        <article class="post post--detail mysql-article">
          <header>
            <h2><a rel="bookmark" href="/mysql/05/18-sql.html">第18章：SQL优化实战 ⭐⭐⭐⭐⭐</a></h2>
            <div class="meta"><span>MySQL教程 / 05</span></div>
          </header>
          <div class="vditor-reset post__content"><h1>第18章：SQL优化实战 ⭐⭐⭐⭐⭐</h1>
<blockquote>
...
<p><strong>继续学习：</strong> <a href="/mysql/05/19.html">第19章：索引优化进阶</a></p></div>
          <footer class="rel fn-clear ft__center">
            <a href="/mysql/04/17.html" class="fn-left">上一篇：第17章：数据恢复实战</a>
            <a href="/mysql/05/19.html" class="fn-right">下一篇：第19章：索引优化进阶</a>
          </footer>
        </article>
      </main>
    </section>
