...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-list"></i>&nbsp;第04章：SQL基础</h2></div>
...
<a class="current" href="/mysql/01/04-sql-dql.html">第04章：SQL基础</a>
...
<a class="" href="/mysql/09/33.html">第33章：疑难问题解决方案</a>
      ...
      <main class="mysql-course-main">
        <article class="post post--detail mysql-article">
          <header>
            <h2><a rel="bookmark" href="/mysql/01/04-sql-dql.html">第04章：SQL基础</a></h2>
            <div class="meta"><span>MySQL教程 / 01</span></div>
          </header>
          <div class="vditor-reset post__content"><h1>第04章：SQL基础 - DQL数据查询语言</h1>
<blockquote>
...
<p><strong>继续学习：</strong> <a href="/mysql/01/05-sql.html">第05章：SQL进阶查询</a></p></div>
          <footer class="rel fn-clear ft__center">
            <a href="/mysql/01/03-sql-dml.html" class="fn-left">上一篇：第03章：SQL基础</a>
            <a href="/mysql/01/05-sql.html" class="fn-right">下一篇：第05章：SQL进阶查询</a>
          </footer>
        </article>
      </main>
    </section>
