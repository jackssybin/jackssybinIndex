...
description: 1.pom文件中引用如下 &lt;dependency&gt;
  ...
  &lt;artifactId&gt;springfoxbootstarter&lt;/artifactId&gt;
  &lt;version&gt;3.0.0&lt;/v...
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2020/12/25/1608861698265.html">springBoot2中webflux集成swagger2</a></h2>
            <div class="meta">
      ...
      <div><strong>导读</strong><span>本文归入「Spring Boot 与后端框架」专题，主要记录：1.pom文件中引用如下 &amp;lt;dependency&amp;gt; &amp;lt;groupId&amp;gt;io.springfox&amp;lt;/groupId&amp;gt; &amp;lt;artifactId&amp;gt;springfoxbootstarter&amp;lt;/artifactId&amp;gt; &amp;lt;version&amp;gt;3.0.0&amp;lt;/v...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><p>1.pom文件中引用如下</p>
...
<p>3.启动服务访问
原版页面地址：<a href="http://127.0.0.1:8080/swagger-ui/index.html">http://127.0.0.1:8080/swagger-ui/index.html</a></p>
</div>
        <footer class="tags">
...
<a class="tag" rel="tag" href="/tags/Swagger.html">Swagger</a>
      ...
      <a href="/articles/2020/12/25/1608861326670.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="springBoot2动态数据源以及Mybatis多数据源">上一篇</a>
      <a href="/articles/2020/12/25/1608882277320.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="各种法则定律-引论">下一篇</a>
  </div>
        </footer>
