...
description: 1. 备份原来的yum源 $sudo cp /etc/yum.repos.d/CentOSBase.repo
  /etc/yum.repos.d/CentOSBase.repo.bak 2.设置aliyun的yum源 $sudo wget O
  /etc/yum.repos.d/CentOSBase.repo http:/...
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2020/01/03/1578035132098.html">centos7更新yum阿里源</a></h2>
            <div class="meta">
      ...
      <div><strong>导读</strong><span>本文归入「Linux 运维与部署」专题，主要记录：1. 备份原来的yum源 $sudo cp /etc/yum.repos.d/CentOSBase.repo /etc/yum.repos.d/CentOSBase.repo.bak 2.设置aliyun的yum源 $sudo wget O /etc/yum.repos.d/CentOSBase.repo http:/...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><h1>1. 备份原来的yum源</h1>
<pre><code>$sudo cp /etc/yum.repos.d/CentOS-Base.repo /etc/yum.repos.d/CentOS-Base.repo.bak
</code></pre>
<h1>2.设置aliyun的yum源</h1>
<pre><code>$sudo wget -O /etc/yum.repos.d/CentOS-Base.repo http://mirrors.aliyun.com/repo/Centos-7.repo
</code></pre>
<h1>3.添加EPEL源</h1>
<pre><code>$sudo wget -P /etc/yum.repos.d/ http://mirrors.aliyun.com/repo/epel-7.repo
</code></pre>
<h1>4.清理缓存，生成新缓存，执行yum更新</h1>
...
<a class="tag" rel="tag" href="/tags/E9_98_BF_E9_87_8C_E4_BA_91.html">阿里云</a>
      ...
      <a href="/articles/2020/01/03/1578021520851.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="mysql空间坐标">上一篇</a>
      <a href="/articles/2020/01/04/1578123919824.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="wireshark安装和基本语法">下一篇</a>
  </div>
        </footer>
