...
description: 1.官方文档 knife4j接入文档 2.概述
  ...
  &lt;groupId&gt;io.springfox&lt;/groupId&gt; &lt;artifactId&gt;springfoxs...
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2020/02/27/1582768389143.html">springboot升级swagger-ui进化版knife4j简单集成</a></h2>
            <div class="meta">
                <span class="vditor-tooltipped vditor-tooltipped__n" aria-label="创建日期">
                    <i class="icon-date"></i>
                    <time>2020-02-27/2020-02-27</time>
                </span>
            </div>
        </header>
        <section class="article-guide">
      <div><strong>专题</strong><a href="/topics/spring-backend.html">Spring Boot 与后端框架</a></div>
      <div><strong>导读</strong><span>本文归入「Spring Boot 与后端框架」专题，主要记录：1.官方文档 knife4j接入文档 2.概述 引入基础包，如果老项目以前有swagger做doc文档。那就省事了。可以直接引入新ui包 &amp;lt;dependency&amp;gt; &amp;lt;groupId&amp;gt;io.springfox&amp;lt;/groupId&amp;gt; &amp;lt;artifactId&amp;gt;springfoxs...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><h3>1.官方文档</h3>
<p><a href="https://doc.xiaominfo.com/guide/useful.html#java%E5%BC%80%E5%8F%91">knife4j接入文档</a></p>
<h3>2.概述</h3>
<p>引入基础包，如果老项目以前有swagger做doc文档。那就省事了。可以直接引入新ui包</p>
<pre><code>
&lt;dependency&gt;
...
<p>新ui包 ，我用的 lastVersion =1.9.6</p>
<pre><code>&lt;dependency&gt;
...
<h3>4.添加访问路径 doc.html 和swagger-ui.html 同理</h3>
<p>SpringBoot中访问<code>doc.html</code></p>
<p>实现SpringBoot的<code>WebMvcConfigurer</code>接口，添加相关的<code>ResourceHandler</code>,代码如下：</p>
<pre><code>
...
<h3>5.成果展示</h3>
<p><img src="https://doc.xiaominfo.com/images/s1.png" alt="null"></p>
</div>
        <footer class="tags">
...
<a class="tag" rel="tag" href="/tags/Spring_20Boot.html">Spring Boot</a>
      ...
      <a href="/articles/2020/02/20/1582211908887.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="mysql中information_schema用途">上一篇</a>
      <a href="/articles/2020/03/05/1583419653736.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="JVM指令手册">下一篇</a>
  </div>
        </footer>
