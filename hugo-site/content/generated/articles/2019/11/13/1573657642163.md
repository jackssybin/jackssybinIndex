...
description: 1.本地登陆 赋权 GRANT ALL PRIVILEGES ON . TO 'root'@'%' IDENTIFIED BY
  '密码' WITH GRANT OPTION; &nbsp;FLUSH PRIVILEGES; 2. 修改本地绑定端口
  /etc/mysql/mysql.cnf 查找bind 127.0.0....
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2019/11/13/1573657642163.html">mysql允许远程连接</a></h2>
            <div class="meta">
                <span class="vditor-tooltipped vditor-tooltipped__n" aria-label="创建日期">
                    <i class="icon-date"></i>
                    <time>2019-11-13/2019-11-13</time>
                </span>
            </div>
        </header>
        <section class="article-guide">
      <div><strong>专题</strong><a href="/topics/mysql-data.html">MySQL 与数据架构</a></div>
      <div><strong>导读</strong><span>本文归入「MySQL 与数据架构」专题，主要记录：1.本地登陆 赋权 GRANT ALL PRIVILEGES ON . TO &#39;root&#39;@&#39;%&#39; IDENTIFIED BY &#39;密码&#39; WITH GRANT OPTION; &amp;nbsp;FLUSH PRIVILEGES; 2. 修改本地绑定端口 /etc/mysql/mysql.cnf 查找bind 127.0.0....</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><h5>1.本地登陆 赋权</h5>
<pre><code>GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' IDENTIFIED BY '密码' WITH GRANT OPTION;
 FLUSH PRIVILEGES;
</code></pre>
<h5>2. 修改本地绑定端口</h5>
<pre><code>/etc/mysql/**mysql.cnf
查找bind 127.0.0.1 注释掉即可
      ...
      <a href="/articles/2019/11/11/1573460631525.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="阿里云Ubuntu16.04安装Java8_redis">上一篇</a>
      <a href="/articles/2019/11/14/1573728964758.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="Ubuntu16.04中PHP7.2 安装pdo_mysql扩展">下一篇</a>
  </div>
        </footer>
