...
description: 1.安装编译相关工具 yum y groupinstall "Development tools" yum y install
  zlibdevel bzip2devel openssldevel ncursesdevel sqlitedevel readlinedevel
  tkdevel gdbmdevel db4de...
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2019/11/30/1575088937927.html">Centos7安装Python3.7</a></h2>
            <div class="meta">
      ...
      <div><strong>导读</strong><span>本文归入「Linux 运维与部署」专题，主要记录：1.安装编译相关工具 yum y groupinstall &quot;Development tools&quot; yum y install zlibdevel bzip2devel openssldevel ncursesdevel sqlitedevel readlinedevel tkdevel gdbmdevel db4de...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><h2>1.安装编译相关工具</h2>
...
<h2>3.编译安装</h2>
<pre><code>mkdir /usr/local/python3 #创建编译安装目录
cd Python-3.7.0
...
<a class="tag" rel="tag" href="/tags/CentOS.html">CentOS</a>
      ...
      <a href="/articles/2019/11/23/1574501821804.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="centos7下安装redis">上一篇</a>
      <a href="/articles/2019/11/30/1575091289510.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="centos7 安装chromedriver">下一篇</a>
  </div>
        </footer>
