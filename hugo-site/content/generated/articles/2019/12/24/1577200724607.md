...
description: 问题描述
  ...
  解决思路 1、在程序中使用java的函数设定时区。 2、在启动java程序时加参数Duser.timezone=GMT+8 3、修改/e...
...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2019/12/24/1577200724607.html">Centos7时间和java获取时间不一致</a></h2>
            <div class="meta">
                <span class="vditor-tooltipped vditor-tooltipped__n" aria-label="创建日期">
                    <i class="icon-date"></i>
                    <time>2019-12-24/2019-12-24</time>
                </span>
            </div>
        </header>
        <section class="article-guide">
      <div><strong>专题</strong><a href="/topics/java-jvm.html">Java 与 JVM</a></div>
      <div><strong>导读</strong><span>本文归入「Java 与 JVM」专题，主要记录：问题描述 遇到一个问题，web显示的时间比服务器时间快12小时。Tomcat和MySQL安装在同一台服务器，系统是centos7，且服务器时间和MySQL时间一致，均是当前北京时间。 解决思路 1、在程序中使用java的函数设定时区。 2、在启动java程序时加参数Duser.timezone=GMT+8 3、修改/e...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><h2>问题描述</h2>
<p>遇到一个问题，web显示的时间比服务器时间快12小时。Tomcat和MySQL安装在同一台服务器，系统是centos7，且服务器时间和MySQL时间一致，均是当前北京时间。</p>
<h2>解决思路</h2>
<p>1、在程序中使用java的函数设定时区。
2、在启动java程序时加参数-Duser.timezone=GMT+8
3、修改/etc/sysconfig/clock文件，然后重启服务。 （PS：jre是从/etc/sysconfig/clock这个文件中获取时区信息的）</p>
<p>附/etc/sysconfig/clock文件内容：</p>
<pre><code>#设置上海时区
ZONE=&quot;Asia/Shanghai&quot;
UTC=false
ARC=false
...
<p>4、修改MySQL连接参数</p>
<pre><code>jdbc:mysql://localhost:3306/test?useUnicode=true&amp;characterEncoding=UTF-8&amp;useOldAliasMetadataBehavior=true&amp;autoReconnect=true&amp;serverTimezone=UTC
</code></pre>
<p>自此终于能看到正常的时间了</p>
</div>
        <footer class="tags">
...
<a class="tag" rel="tag" href="/tags/Java.html">Java</a>
      ...
      <a href="/articles/2019/12/20/1576776196766.html" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="Centos下git pull免密码操作">上一篇</a>
      <a href="/articles/2020/01/03/1578021520851.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="mysql空间坐标">下一篇</a>
  </div>
        </footer>
