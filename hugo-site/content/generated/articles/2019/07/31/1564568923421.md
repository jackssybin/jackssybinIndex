...
<div class="wrapper">
    ...
    <article class="post post--detail">
        <header>
            <h2><a rel="bookmark" href="/articles/2019/07/31/1564568923421.html">Lists.transform的使用和采坑</a></h2>
            <div class="meta">
      ...
      <div><strong>导读</strong><span>本文归入「Java 与 JVM」专题，主要记录：Lists.transform的使用 Lists.transform：能够轻松的从一种类型的list转换为另一种类型的list。 Map&amp;lt;String,String&amp;gt; map = Maps.newHashMap(); map.put(&quot;a&quot;,&quot;testa&quot;); map.put(&quot;b&quot;,&quot;test2&quot;); m...</span></div>
  </section>
        
        <div id="more" class="vditor-reset post__content"><p><img src="https://img.hacpai.com/bing/20180209.jpg?imageView2/1/w/960/h/540/interlace/1/q/100" alt=""></p>
<h1>Lists.transform的使用</h1>
<p><strong>Lists.transform：能够轻松的从一种类型的list转换为另一种类型的list</strong>。</p>
...
<p>还有采坑的，得需要注意下</p>
<pre><code>  List&lt;User&gt; userdbs = Lists.newArrayList(new User(&quot;zhangsan&quot;, &quot;20&quot;),
...
<p><strong><strong>对原数据集users的修改会直接影响到Lists.transform方法返回的结果userVos，</strong></strong>
<strong><strong>解决方案还是用 lambda 把方便快捷</strong></strong></p>
<p>参考<a href="https://">https://blog.csdn.net/mnmlist/article/details/53870520</a></p>
</div>
        <footer class="tags">
            <a class="topic-pill" href="/topics/java-jvm.html">Java 与 JVM</a>
            <a class="tag" rel="tag" href="/tags/guava.html">guava</a>
            <div class="rel fn-clear ft__center">
      <a href="/my-github-repos" rel="prev" class="fn-left vditor-tooltipped vditor-tooltipped__n" aria-label="我在 GitHub 上的开源项目">上一篇</a>
      <a href="/articles/2019/09/16/1568646255462.html" rel="next" class="fn-right vditor-tooltipped vditor-tooltipped__n" aria-label="python基础之常用模块">下一篇</a>
  </div>
        </footer>
...
<li>
    ...
    <h3>旧评论归档</h3>
    <article class="comment" id="1564569514636">
        ...
        <main>
            ...
            <div class="vditor-reset"><p>每次看到 Guava 我都会想起 “瓜娃子” ?</p>
</div>
        </main>
    </article>
</section>
