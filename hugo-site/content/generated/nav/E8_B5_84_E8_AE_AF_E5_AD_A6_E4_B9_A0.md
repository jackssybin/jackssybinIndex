---
title: 资讯学习 - 网址导航
description: 资讯学习 分类网址导航。
url: /nav/E8_B5_84_E8_AE_AF_E5_AD_A6_E4_B9_A0.html
kind: page
---
...
<div class="wrapper">
    <div class="main-wrap">
        <main class="other">
    <div class="title"><h2><i class="icon-link"></i>&nbsp;资讯学习</h2></div>
    <section class="nav-category">
    <p>资讯学习 分类下共 10 个站点。</p>
...
<div class="nav-section">
      <h3>设计规范</h3>
      <div class="nav-grid"><a class="nav-card" href="http://designguidelines.co/" target="_blank" rel="noopener nofollow">
...
<div class="nav-section">
      <h3>视频教程</h3>
      <div class="nav-grid"><a class="nav-card" href="http://www.photoshoplady.com/" target="_blank" rel="noopener nofollow">
