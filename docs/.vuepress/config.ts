...
export default defineUserConfig({
  ...
  description: "记录精彩的程序人生，专注 Java、MySQL、Spring Boot、Netty、Linux 与后端工程实践。",
  ...
  head: [
    ...
    ["meta", { name: "keywords", content: "Java,MySQL,Spring Boot,Netty,Linux,后端开发,技术博客,教程,jackssybin" }],
    ["meta", { property: "og:site_name", content: "jackssybin 的个人博客" }],
    ["meta", { property: "og:type", content: "website" }],
    ["meta", { property: "og:title", content: "jackssybin 的个人博客" }],
    ["meta", { property: "og:description", content: "记录精彩的程序人生，专注 Java、MySQL、Spring Boot、Netty、Linux 与后端工程实践。" }],
