...
![七个标签页的真实能力边界](/root/jackssybinIndex/content-ops/agnes-image-tool-gradio-studio-source-deep-dive/media/diagram-tabs.png)
...
![帧数 8n+1 约束的源码证据](/root/jackssybinIndex/content-ops/agnes-image-tool-gradio-studio-source-deep-dive/media/diagram-8n1.png)
