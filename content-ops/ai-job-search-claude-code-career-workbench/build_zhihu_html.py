#!/usr/bin/env python3
"""Build zhihu-compact.html from zhihu.md for ai-job-search tutorial."""
import re
...
SITE_BASE = "https://jackssybin.cn/images/ai-job-search-claude-code-career-workbench"
...
out_parts.append("<h1>Claude Code + 9 个命令 + 双 agent，我看到了 AI 用得最深的一份求职工作台</h1>")
skip_first_h1 = True
